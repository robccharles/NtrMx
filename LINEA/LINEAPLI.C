...
{
	 clrscr() ;
	 printf("        APOYO DIDACTICO DE APLICACION DE MICROS Versi¢n 1.0\n\n" ) ;
	 printf("                         MENU DE AYUDA \n\n" ) ;
	 printf("             OPCION                            TECLEAR\n") ;
	 printf("         LISTAR MEMORIA                          L <dir>\n") ;
	 printf("         MODIFICAR MEMORIA                       M <dir>\n") ;
	 ...
	 printf("         DESENSAMBLAR MEMORIA                    D <dir>\n") ;
	 printf("         DESPLEGAR/MODIFICAR REGISTROS           R <reg>\n");
	 printf("         ESCRITURA A PUERTOS                     O dir\n");
	 printf("         LECTURA DE PUERTOS                      I dir\n") ;
	 printf("         DESPLEGAR MENU DE AYUDA                 S\n") ;
	 printf("         SALIR DE EJECUCION                      [ESC]\n") ;
	 printf("         SALIR DE PROGRAMA                       A\n\n") ;

	 printf("    VALORES OPCIONALES:                  \n") ;
	 printf("                   <dir> = seg:/offset     \n") ;
	 printf("                   <reg> = AX/BX/ ... /IP   \n\n>") ;
